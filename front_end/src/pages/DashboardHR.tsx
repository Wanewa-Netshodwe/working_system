                ...
                <div>
                  ...
                  >
                    {analytics?.total_records_current!! -
                      analytics?.total_records_prev!! > 0  ? 0  : analytics?.total_records_current!! -
                      ...
                      >
                        <td>
                          <div className=" gap-3 flex w-[180px] items-center right-0">
                            <img
                              src={val.user_id.profile_pic.length > 5 ?  val.user_id.profile_pic :  GenerateAvator(`${val.user_id.fullName}`)}
